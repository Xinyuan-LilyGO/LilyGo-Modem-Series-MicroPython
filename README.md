...
| SimHatAccelerometer             |                  | ❌                  | ❌(No support)      |                 | ❌                 |                 |
| SimHatCurrentSensor             |                  | ❌                  | ❌(No support)      |                 | ❌                 |                 |
| SimHatOneWireSensor             |                  | ❌                  | ❌(No support)      |                 | ❌                 |                 |
| SimHatRelay                     |                  | ❌                  | ❌(No support)      |                 | ❌                 |                 |
| SimHatRS485                     |                  | ❌                  | ❌(No support)      |                 | ❌                 |                 |
| SimHatCanBusRecv                |                  | ❌                  | ❌(No support)      |                 | ❌                 |                 |
| SimHatCanBusSend                |                  | ❌                  | ❌(No support)      |                 | ❌                 |                 |
| ULP_Monitor                     |                  |                    | ❌                  |                 |                   | ❌               |

...
from certs import AmazonRootCA, AWSClientCertificate, AWSClientPrivateKey
...
mqtt_broker = "xxxxxxx.iot.ap-southeast-2.amazonaws.com"  # MQTT Broker address
...
def mqtt_connecting(client_index, server, port, client_id, ssl, keepalive_time=60):
    global __ssl, cert_pem, cert_pem, client_cert_pem, client_key_pem
    __ssl = ssl
...
def main():
    ...
    mqtt_set_certificate(AmazonRootCA, AWSClientCertificate, AWSClientPrivateKey)
